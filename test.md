# Données de Tests pour l'API v2 de Suivi de Séries et Films

## Informations Générales

- **URL Base**: `http://localhost:3000/api/v2`
- **Format d'ID**: Les IDs MongoDB utilisent un format personnalisé (ex: "id0001", "id0002", "id0164")
